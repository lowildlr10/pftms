        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title white-text">
                    <strong>
                        <i class="far fa-copy"></i> Report: Obligation Ledgers
                    </strong>
                </h5>
                ...
                <div class="card card-cascade z-depth-1 mb-3">
                            ...
                            <div class="btn-group btn-menu-1 p-0">
                                ...
                                <button type="button" class="btn btn-outline-mdb-color
                                        ...
                                        [
                                            'id' => $fund->ledger_id,
                                            'for' => 'obligation',
                                        ]) }}`, `{{ $fund->project_title.' (Obligation Ledger)' }}`);">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-sm btn-mdb-color btn-rounded btn-block waves-effect mb-2"
                                onclick="$(this).showLedger(`{{ route('report-obligation-ledger-show',
                                [
                                    'id' => $fund->ledger_id,
                                    'for' => 'obligation',
                                    'type' => 'saa',
                                ]) }}`, `{{ $fund->project_title.' (Obligation Ledger)' }}`);">
                                <i class="fas fa-eye"></i> Show Obligation Ledger
                        </button>
                        @endif
                    </div>
                </div>
