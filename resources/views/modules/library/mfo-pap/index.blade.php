        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title white-text">
                    <strong>
                        <i class="fas fa-book"></i> Libraries: MFO/PAP
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1 white-text">
                    ...
                    <li class="active">
                        <a href="{{ route('mfo-pap') }}" class="waves-effect waves-light cyan-text">
                            MFO/PAP
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2"
                                    onclick="$(this).showCreate('{{ route('mfo-pap-show-create') }}');">
                        ...
                        <div>
                            ...
                            <a href="{{ route('mfo-pap') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                    ...
                    <div class="px-2">
                        <div class="table-wrapper table-responsive border rounded">
                            ...
                            <table id="dtmaterial" class="table table-hover" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @if (count($list) > 0)
                                        @foreach ($list as $listCtr => $pap)
                                    <tr>
                                        <td></td>
                                        <td class="border-left">{{ $pap->code }}
                                        <td class="border-left">{{ $pap->description }}</td>
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-orange p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showEdit('{{ route('mfo-pap-show-edit',
                                                                                    ['id' => $pap->id]) }}');"
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showDelete('{{ route('mfo-pap-delete', ['id' => $pap->id]) }}',
                                                                           '{{ $pap->description }}');"
...
<script src="{{ asset('assets/js/mfo-pap.js') }}"></script>
