        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title white-text">
                    <strong>
                        <i class="fas fa-users-cog"></i> Account Management: User Groups
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1 white-text">
                    ...
                    <li class="active">
                        <a href="{{ route('emp-group') }}" class="waves-effect waves-light cyan-text">
                            User Groups
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2"
                                    onclick="$(this).showCreate('{{ route('emp-group-show-create') }}');">
                        ...
                        <div>
                            ...
                            <a href="{{ route('emp-group') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showDelete('{{ route('emp-group-delete', ['id' => $group->id]) }}',
                                                                           '{{ $group->group_name }}');"
...
<script src="{{ asset('assets/js/emp-group.js') }}"></script>
