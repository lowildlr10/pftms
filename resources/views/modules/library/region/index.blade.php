        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title white-text">
                    <strong>
                        <i class="fas fa-globe-asia"></i> Places: Regions
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1 white-text">
                    ...
                    <li class="active">
                        <a href="{{ route('region') }}" class="waves-effect waves-light cyan-text">
                            Regions
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <a href="#" class="btn btn-outline-white btn-rounded btn-sm px-2"
                               onclick="$(this).showCreate('{{ route('region-show-create') }}');">
                        ...
                        <div>
                            ...
                            <a href="{{ route('region') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showDelete('{{ route('region-delete', ['id' => $region->id]) }}',
                                                                           '{{ $region->region_name }}');"
