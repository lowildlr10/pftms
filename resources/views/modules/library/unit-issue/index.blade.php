        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title white-text">
                    <strong>
                        <i class="fas fa-book"></i> Libraries: Unit of Issues
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1 white-text">
                    ...
                    <li class="active">
                        <a href="{{ route('item-unit-issue') }}" class="waves-effect waves-light cyan-text">
                            Unit of Issues
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2"
                                    onclick="$(this).showCreate('{{ route('item-unit-issue-show-create') }}');">
                        ...
                        <div>
                            ...
                            <a href="{{ route('item-unit-issue') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                ...
                                <thead class="mdb-color darken-3 white-text">
                                    <tr>
                                        ...
                                        <th class="th-md" width="91%">
                                            <strong>Unit of Issue Name</strong>
                                        </th>
                                        <th class="th-md" width="3%"></th>
                                        <th class="th-md" width="3%"></th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showDelete('{{ route('item-unit-issue-delete', ['id' => $unit->id]) }}',
                                                                           '{{ $unit->unit_name }}');"
...
<script src="{{ asset('assets/js/unit-issue.js') }}"></script>
