        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title white-text">
                    <strong>
                        <i class="fas fa-book"></i> Libraries: Monitoring Offices
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1 white-text">
                    ...
                    <li class="active">
                        <a href="{{ route('monitoring-office') }}" class="waves-effect waves-light cyan-text">
                            Monitoring Offices
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2"
                                    onclick="$(this).showCreate('{{ route('monitoring-office-show-create') }}');">
                        ...
                        <div>
                            ...
                            <a href="{{ route('monitoring-office') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                            ...
                            <table id="dtmaterial" class="table table-hover" cellspacing="0" width="100%">
                                ...
                                <thead class="mdb-color darken-3 white-text">
                                    <tr>
                                        ...
                                        <th class="th-md" width="30%">
                                            <strong>Agency/LGU</strong>
                                        </th>
                                        <th class="th-md" width="61%">
                                ...
                                <tbody>
                                    @if (count($list) > 0)
                                        @foreach ($list as $listCtr => $office)
                                    <tr>
                                        <td></td>
                                        <td class="border-left">{{ $office->agency_lgu_name }}</td>
                                        <td>{{ $office->office_name }}</td>
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-orange p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showEdit('{{ route('monitoring-office-show-edit',
                                                                                    ['id' => $office->id]) }}');"
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showDelete('{{ route('monitoring-office-delete', ['id' => $office->id]) }}',
                                                                           '{{ $office->office_name }}');"
...
<script src="{{ asset('assets/js/monitoring-office.js') }}"></script>
