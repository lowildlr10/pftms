        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title white-text">
                    <strong>
                        <i class="fas fa-globe-asia"></i> Places: Provinces
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1 white-text">
                    ...
                    <li class="active">
                        <a href="{{ route('province') }}" class="waves-effect waves-light cyan-text">
                            Provinces
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <a href="#" class="btn btn-outline-white btn-rounded btn-sm px-2"
                               onclick="$(this).showCreate('{{ route('province-show-create') }}');">
                        ...
                        <div>
                            ...
                            <a href="{{ route('province') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                    ...
                    <div class="px-2">
                        <div class="table-wrapper table-responsive border rounded">
                            ...
                            <table id="dtmaterial" class="table table-hover" cellspacing="0" width="100%">
                                ...
                                <thead class="mdb-color darken-3 white-text">
                                    <tr>
                                        ...
                                        <th class="th-md" width="50%">
                                            <strong>City/Province Name</strong>
                                        </th>
                                ...
                                <tbody>
                                    @if (count($list) > 0)
                                        @foreach ($list as $listCtr => $province)
                                    <tr>
                                        <td></td>
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-orange p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showEdit('{{ route('province-show-edit',
                                                                                   ['id' => $province->id]) }}');"
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showDelete('{{ route('province-delete', ['id' => $province->id]) }}',
