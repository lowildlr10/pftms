        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title white-text">
                    <strong>
                        <i class="fas fa-book"></i> Libraries: Mode of Procurement
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1 white-text">
                    ...
                    <li class="active">
                        <a href="{{ route('procurement-mode') }}" class="waves-effect waves-light cyan-text">
                            Mode of Procurement
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2"
                                    onclick="$(this).showCreate('{{ route('procurement-mode-show-create') }}');">
                        ...
                        <div>
                            ...
                            <a href="{{ route('procurement-mode') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showDelete('{{ route('procurement-mode-delete', ['id' => $mode->id]) }}',
                                                                           '{{ $mode->mode_name }}');"
...
<script src="{{ asset('assets/js/procurement-mode.js') }}"></script>
