        ...
        <div class="card mdb-color darken-3">
            <div class="card-body">
                ...
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1 white-text">
                    ...
                    <li class="active">
                        <a href="{{ route('signatory') }}" class="waves-effect waves-light cyan-text">
                            Signatories
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <a href="#" class="btn btn-outline-white btn-rounded btn-sm px-2"
                               onclick="$(this).showCreate('{{ route('signatory-show-create') }}');">
                        ...
                        <div>
                            ...
                            <a href="{{ route('signatory') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                               onclick="$(this).showDelete('{{ route('signatory-delete', ['id' => $sig->id]) }}',
                                                                           '{{ $sig->name }}');"
...
<script src="{{ asset('assets/js/signatories.js') }}"></script>
