                ...
                <div class="card card-cascade narrower">
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            ...
                            <a href="{{ url('procurement/po-jo') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                ...
                                <tbody>
                                    <form id="form-validation" method="POST" action="#">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" class="border-left">
                                                <a class="btn btn-link p-0" href="{{ url('procurement/po-jo?search=' . $pr->pr_no) }}">
                                                    {{ $pr->pr_no }}
                                                </a>
                                            </td>
                                                    ...
                                                    <div class="card-body p-2">
                                                        <table class="table table table-sm z-depth-1 mb-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($pr->po_item as $listCtr1 => $item)
                                                                <tr class="row-item">
                                                                    <td align="center">
                                                                        @if ($item->status_id == 3)
                                                                    ...
                                                                    <td align="center" class="border-left"><strong>{{ $item->po_no }}</strong></td>
                                                                    <td align="center" class="border-left">
                                                                        <strong>
                                                                            <h6 class="mb-0">
                                                                                {{ $item->company_name }}
                                                                                <span class="mdb-color-text">
                                                                                    [ {{ strtoupper($item->type) }} Document ]
                                                                                </span>
                                                                            </h6>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header stylish-color-dark white-text">
                <h6>
                    ...
                    <strong>{{ strtoupper($item->type) }} NO: {{ $item->po_no }}</strong>
                </h6>
                    ...
                    <div class="gradient-card-header rgba-white-light p-0">
                        <div class="p-0">
                            <div class="btn-group btn-menu-1 p-0">
                                ...
                                <button type="button" class="btn btn-outline-mdb-color
                                        btn-sm px-2 waves-effect waves-light"
                                        onclick="$(this).viewCreate('{{ $item->po_no }}', '{{ $item->type }}');
                                                 $('#edit-title').text('EDIT {{ strtoupper($item->type) }} [ {{ $item->po_no }} ]');">
                ...
                <ul class="list-group z-depth-0">
                    ...
                    <li class="list-group-item justify-content-between">
                        <button type="button" class="btn btn-outline-warning waves-effect btn-block btn-md btn-rounded"
                                onclick="$(this).viewIssue('{{ $item->po_no }}', '{{ $item->type }}');">
