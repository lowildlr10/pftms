        ...
        <div class="card text-white mdb-color darken-3">
            <div class="card-body">
                ...
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1">
                    ...
                    <li class="active">
                        <a href="{{ url('libraries/projects') }}" class="waves-effect waves-light cyan-text">
                            Charging/Funding
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2"
                                    onclick="$(this).showCreate('project')">
                        ...
                        <div>
                            ...
                            <a href="{{ url('libraries/projects') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                ...
                                <thead class="mdb-color darken-3 white-text">
                                    <tr>
                                        ...
                                        <th class="th-md" width="81%">
                                            <strong>Project/Charging Name</strong>
                                        </th>
                                ...
                                <tbody>
                                    <form id="form-validation" method="POST" action="#">
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-left">{{ $project->reference_code }}</td>
                                            <td class="border-left">{{ $project->project }}</td><td align="center" class="border-left">
                                                <a class="btn-floating btn-sm btn-orange p-2 waves-effect material-tooltip-main mr-0"
                                                   onclick="$(this).showEdit('{{ $project->id }}', 'project')"
                                            ...
                                            <td align="center">
                                                <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                                   onclick="$(this).delete('{{ $project->id }}', 'project')"
