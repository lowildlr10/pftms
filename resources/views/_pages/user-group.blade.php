    ...
    <section class="mb-5 col-12">
        <div class="card text-white mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title">
                    <strong>
                        <i class="fas fa-book"></i> Libraries: User Groups
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1">
                    ...
                    <li class="active">
                        <a href="{{ url('libraries/user-groups') }}" class="waves-effect waves-light cyan-text">
                            User Groups
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2"
                                    onclick="$(this).showCreate('user_group')">
                        ...
                        <div>
                            ...
                            <a href="{{ url('libraries/unit-issue') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                ...
                                <tbody>
                                    <form id="form-validation" method="POST" action="#">
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-left">{{ $group->group_name }}</td>
                                            <td class="border-left">{{ $group->group_head }}</td>
                                            <td align="center" class="border-left">
                                                <a class="btn-floating btn-sm btn-orange p-2 waves-effect material-tooltip-main mr-0"
                                                   onclick="$(this).showEdit('{{ $group->group_id }}', 'user_group')"
                                            ...
                                            <td align="center">
                                                <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                                   onclick="$(this).delete('{{ $group->group_id }}', 'user_group')"
