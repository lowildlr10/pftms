<div class="modal fade top" id="modal-approval" tabindex="-1"
    ...
    <div class="modal-dialog modal-top" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <h6 id="modal-body-approval"></h6>
                <form id="form-approval" action="#" method="POST">@csrf</form>
            </div>
            ...
            <div class="modal-footer p-1">
                <button type="button" class="btn btn-green btn-sm waves-effect waves-light"
                        ...
                        <i class="fas fa-flag"></i> Approval
                </button>
