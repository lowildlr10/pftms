<div class="modal fade top" id="modal-issue-back" tabindex="-1"
    ...
    <div class="modal-dialog modal-top" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <div class="card">
                    <div class="card-body">
                        <div id="modal-body-issue-back" style="display: none;"></div>
                    </div>
                </div>
            </div>
