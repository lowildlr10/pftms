    ...
    <section class="mb-5 col-12">
        <div class="card text-white mdb-color darken-3">
            <div class="card-body">
                <h5 class="card-title">
                    <strong>
                        <i class="fas fa-book"></i> Libraries: Signatories
                    </strong>
                </h5>
                <hr class="white">
                <ul class="breadcrumb mdb-color darken-3 mb-0 p-1">
                    ...
                    <li class="active">
                        <a href="{{ url('libraries/signatories') }}" class="waves-effect waves-light cyan-text">
                            Signatories
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="gradient-card-header unique-color
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2"
                                    onclick="$(this).showCreate('signatory')">
                        ...
                        <div>
                            ...
                            <a href="{{ url('libraries/signatories') }}" class="btn btn-outline-white btn-rounded btn-sm px-2">
                        ...
                        <div class="table-wrapper table-responsive border rounded">
                            ...
                            <div class="hidden-xs my-2">
                                ...
                                <a class="btn btn-sm btn-outline-red waves-effect my-0 py-0 px-1"
                                   href="{{ url('libraries/signatories') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a class="btn-floating btn-sm btn-red p-2 waves-effect material-tooltip-main mr-0"
                                                   onclick="$(this).delete('{{ $sig->id }}', 'signatory')"
