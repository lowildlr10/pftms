...
class DocLineItemBudget extends PDF {
    public function printLIB($data) {
        ...
        $this->SetFont('helvetica', 'B', 9);
        $this->Cell($pageWidth * 0.26, 5, 'Project Title', 0, 0, 'L');
        $this->Cell($pageWidth * 0.01, 5, ':', 0, 0, 'C');
        $this->SetFont('helvetica', '', 9);
        $this->MultiCell(0, 5, $title, 0, 'L');

        $this->SetFont('helvetica', 'B', 9);
        $this->Cell($pageWidth * 0.26, 5, 'Period Covered', 0, 0, 'L');
        $this->Cell($pageWidth * 0.01, 5, ':', 0, 0, 'C');
        $this->SetFont('helvetica', '', 9);
        ...
        $this->SetFont('helvetica', 'B', 9);
        $this->Cell($pageWidth * 0.26, 5, 'Implementing Agency/Office', 0, 0, 'L');
        $this->Cell($pageWidth * 0.01, 5, ':', 0, 0, 'C');
        $this->SetFont('helvetica', '', 9);
        ...
        $this->SetFont('helvetica', 'B', 9);
        $this->Cell($pageWidth * 0.26, 5, 'Co-Implementing Agencies/Offices', 0, 0, 'L');
        $this->Cell($pageWidth * 0.01, 5, ':', 0, 0, 'C');
        $this->SetFont('helvetica', '', 9);
        ...
        $this->SetFont('helvetica', 'B', 9);
        $this->Cell($pageWidth * 0.26, 5, 'Project Leader', 0, 0, 'L');
        $this->Cell($pageWidth * 0.01, 5, ':', 0, 0, 'C');
        $this->SetFont('helvetica', '', 9);
        ...
        $this->SetFont('helvetica', 'B', 9);
        $this->Cell($pageWidth * 0.26, 5, 'Monitoring Agencies/Offices', 0, 0, 'L');
        $this->Cell($pageWidth * 0.01, 5, ':', 0, 0, 'C');
        $this->SetFont('helvetica', '', 9);
