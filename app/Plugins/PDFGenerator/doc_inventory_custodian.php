...
$pdf->Cell(0, "5", "ICS No : " . $data->inventory_no, "", "", "L");
$pdf->Ln(10);
...
$pdf->SetFont("Times", "B", 10 + ($increaseFontSize * 10));
$pdf->Cell($pageWidth * 0.45, "5", $data->issued_by->name, "LR", "", "C");
$pdf->Cell(0, "5", $data->received_by->name, "R", "", "C");
$pdf->Ln();
...
$pdf->SetFont("Times", "B", 10 + ($increaseFontSize * 10));
$pdf->Cell($pageWidth * 0.45, "5", $data->issued_by->position, "LR", "", "C");
$pdf->Cell(0, "5", $data->received_by->position, "R", "", "C");
$pdf->Ln();
