...
class DocLineItemBudgetRealignment extends PDF {
    public function printRealignmentLIB($data) {
        $pageHeight = $this->h;
        $pageWidth = $this->w;
        $fontScale = $this->fontScale;
        $originalFontSize = $data->header_count <= 8 ? 9 : 8;
        ...
        $this->Cell(0, 4, 'PROPOSED REALIGNMENT', '', '', 'C');
        $this->Ln();
