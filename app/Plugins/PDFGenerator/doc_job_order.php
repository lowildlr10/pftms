...
$pdf->Cell(0,'5', $data->jo->po_no, 0,'L');
...
$pdf->SetFont('Times','B', 11 + ($increaseFontSize * 11));
$pdf->Cell(0, '5', $data->jo->company_name, 0, 'L');
...
$pdf->SetFont('Times','', 11 + ($increaseFontSize * 11));
$pdf->MultiCell(0, '5', $data->jo->address, 0, 'L');
...
//Table data
$pdf->htmlTable($data->jo->table_data);

//Footer data
$pdf->SetFont('Times','', 11 + ($increaseFontSize * 11));
$pdf->Cell(0, '5',"Completion/Delivery : within the specified date of delivery", 0, 'L');
...
$pdf->SetFont('Times', '', 11 + ($increaseFontSize * 11));
$pdf->Cell($contentWidth * 0.16,'5', $data->jo->date_delivery, 0, 'L');
$pdf->SetFont('Times', 'IB', 11 + ($increaseFontSize * 11));
$pdf->Cell($contentWidth * 0.40,'5', "Payment Term:", 0, 0, 'R');
$pdf->SetFont('Times', 'UB', 11 + ($increaseFontSize * 11));
$pdf->Cell(0, '5', "After inspection and acceptance", 0, 0, 'R');
...
$pdf->SetFont('Times', '', 10 + ($increaseFontSize * 10));
$pdf->Cell(0, '5', "Funds Available:", 0, 'L');
...
$pdf->Ln();
$pdf->SetFont('Times', '', 10 + ($increaseFontSize * 10));
$pdf->Cell(0, '5', "             Authorized Signatory", 0, 'L');

$pdf->Ln(13);

$pdf->SetFont('Times', '', 10 + ($increaseFontSize * 10));
$pdf->MultiCell(0, '5', "JOB/WORK ORDER RECEIVED BY: \n__________________________________", 0, 'L');
